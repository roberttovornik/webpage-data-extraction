    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        var imgUrl = "http://script.dotmetrics.net/hit.gif?id=2089&url=" + pageUrl + "&dom=" + domain + "&r=" + rand + "&pvs=" + pvs;
                    ...
                    window.DotMetricsSettings =
                                {
                                    ...
                                    ScriptDebugUrl:  "http://demo-script.dotmetrics.net/Scripts/script.debug.js?v=b6da9f83-2e4f-44f1-b4da-4607753b9156",
